...
Berikut adalah langkah-langkah penggunaan aplikasi FINARA beserta penjelasan dari setiap bagian (harap sesuaikan *path* gambar dengan *screenshot* aplikasi Anda):

### 1. Beranda (Home)
![Tampilan Beranda](assets/beranda.png)
*(Catatan: Masukkan gambar screenshot Beranda di sini)*
...
![Tampilan Grafik](assets/grafik.png)
*(Catatan: Masukkan gambar screenshot Grafik di sini)*
...
### 3. Tujuan (Goals)
![Tampilan Tujuan](assets/tujuan.png)
*(Catatan: Masukkan gambar screenshot Tujuan di sini)*
...
![Tampilan Pengaturan](assets/pengaturan.png)
*(Catatan: Masukkan gambar screenshot Pengaturan di sini)*
